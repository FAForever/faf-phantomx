        table.insert(globalOpts,
        {
          ...
          pref = 'PhantomX_Bonus_Multiplier',
            values = {
             {
                    text = "<LOC phantomx_0003>120%",
                    help = "<LOC phantomx_0004>120%",
                    key = '120',
                },
             {
                    text = "<LOC phantomx_0005>110%",
                    help = "<LOC phantomx_0006>110%",
                    key = '110',
                },
             {
                    text = "<LOC phantomx_0007>100%",
                    help = "<LOC phantomx_0008>100%",
                    key = '100',
                },
                {
                    text = "<LOC phantomx_0009>90%",
                    help = "<LOC phantomx_0010>90%",
                    key = '90',
                },
                {
                    text = "<LOC phantomx_0011>80%",
                    help = "<LOC phantomx_0012>80%",
                    key = '80',
                },
          },
       }
...
###
        ...
        table.insert(globalOpts,
        {
          ...
          pref = 'PhantomX_Paladin_Bonus',
            values = {
             {
                    text = "<LOC phantomx_0045>65%",
                    help = "<LOC phantomx_0046>65%",
                    key = '65',
                },
             {
                    text = "<LOC phantomx_0047>55%",
                    help = "<LOC phantomx_0048>55%",
                    key = '55',
                },
             {
                    text = "<LOC phantomx_0049>45%",
                    help = "<LOC phantomx_0050>45%",
                    key = '45',
                },
                {
                    text = "<LOC phantomx_0051>35%",
                    help = "<LOC phantomx_0052>35%",
                    key = '35',
                },
                {
                    text = "<LOC phantomx_0053>25%",
                    help = "<LOC phantomx_0054>25%",
                    key = '25',
                },
          },
       }
